...
// DEBUG_TP_DSC - adds template description (basically uses __PRETTY_FUNCTION__ - non-standard macro defined by gcc, instead of __func__)
//
...
#endif // ifndef DEBUG_TP_SCP

#define LOG std::cerr << DEBUG_GCT << __PRETTY_FUNCTION__ << std::endl
#define DELOG std::cerr << DEBUG_GCT << "exitting " << __PRETTY_FUNCTION__ << std::endl
